...
rsync -v -a -e 'ssh' site.pp manifests modules pi@${ip}:/home/pi/puppet/

# Run puppet on the host
ssh pi@${1} 'sudo puppet apply --verbose --modulepath /home/pi/puppet/modules /home/pi/puppet/site.pp'
